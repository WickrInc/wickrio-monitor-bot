...
# Example:
# old location: '/opt/WickrIODebug/clients/monitor_bot/integration/monitor_bot'
# new location: '/opt/WickrIODebug/clients/monitor_bot/integration/monitor_bot.new'
#
...
#
set +e
cp -f processes.json combined.log $NEW_BOT_LOCATION
set -e
...
echo $PWD
ls
rm -rf monitor_bot.old_Version
mv $OLD_BOT_LOCATION monitor_bot.old_Version
